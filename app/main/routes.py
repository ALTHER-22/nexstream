...
def play_episode(episode_id):
    ...
    if episode.video_url:
        if 'ok.ru/video/' in episode.video_url:
            episode.video_url = episode.video_url.replace('ok.ru/video/', 'ok.ru/videoembed/')
        ...
        if any(d in episode.video_url.lower() for d in ['ok.ru', 'youtube', 'youtu.be', 'vimeo', 'drive.google.com', 'vk.com', 'vk.ru', 'vkvideo.ru']):
            is_embed = True
...
def play_movie(movie_id):
    ...
    is_embed = False
    if movie.video_url:
        if 'ok.ru/video/' in movie.video_url:
            movie.video_url = movie.video_url.replace('ok.ru/video/', 'ok.ru/videoembed/')
        ...
        if any(d in movie.video_url.lower() for d in ['ok.ru', 'youtube', 'youtu.be', 'vimeo', 'drive.google.com', 'vk.com', 'vk.ru', 'vkvideo.ru']):
            is_embed = True
